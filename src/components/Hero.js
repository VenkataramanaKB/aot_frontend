...
const Hero = () => {
  ...
  useEffect(() => {
    if (!isLoading) {
      // GSAP animations for child elements of `contentRef`
      ...
      gsap.fromTo(
        ...
        { opacity: 0, y: 50 }, // Start hidden and below
        {
          ...
          y: 0,
          duration: 1,
          stagger: 0.2, // Adds delay between animations for each element
          ease: "power2.out",
          scrollTrigger: {
            trigger: contentRef.current,
            start: "top center", // Animation starts when content reaches the center
